...
2. Hawkes-сигнал в данных есть — как видно из первого пункта. Однако он слабый и неоднородный по разным кросс-Хоукс зависимостям. Из-за сильной корреляции между диагональным Хоукс-сигналом и общим бейзлайном диагональные элементы учатся сложно: большая неопределённость по ним сохраняется даже на 207d обучающей выборки. Важно, что это структурная особенность, а не огрехи обучения.
