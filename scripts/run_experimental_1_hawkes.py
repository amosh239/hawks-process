...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run experimental pooled multi-kernel Hawkes on current diploma split")
    parser.add_argument(
        "--data-path",
    ...
    parser.add_argument("--max-iter", type=int, default=120, help="Optimizer max iterations")
    parser.add_argument(
        "--output-dir",
        default="diploma/reports/experimental_1_hawkes",
        help="Directory for experimental Hawkes artifacts",
    )
