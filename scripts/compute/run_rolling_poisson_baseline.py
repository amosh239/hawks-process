...
from src.diploma_baselines import run_rolling_poisson_experiment


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run rolling-mean Poisson baseline on daily user panel")
    parser.add_argument(
        "--data-path",
    ...
    parser.add_argument(
        "--output-dir",
        default="diploma/reports/rolling_poisson_baseline",
...
def main() -> None:
    args = parse_args()
    summary = run_rolling_poisson_experiment(
