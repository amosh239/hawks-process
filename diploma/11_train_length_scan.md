...
Гонятся 7 вероятностных моделей из глав 1–8 (без GBDT — слишком долгий fit для такой сетки):
...
```bash
python scripts/run_train_length_scan.py     # ~12 минут на 216 прогонов
