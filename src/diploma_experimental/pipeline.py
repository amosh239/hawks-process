...
def run_experimental_1_hawkes(
    ...
    plot_daily_aggregate_hawkes_vs_baseline(
        ...
        model_label="Experimental Hawkes",
        title="Daily aggregate intensity: personalized Poisson vs Hawkes",
    )
    plot_hawkes_alpha_heatmap(
    ...
    plot_user_ll_gain_histogram(
        ...
        model_col="ll_experimental_hawkes",
        out_path=output_dir / "user_ll_gain_hist.png",
        xlabel="Delta user-level test LL (Hawkes - personalized Poisson)",
        title="User-level LL gain of experimental Hawkes",
    )
    plot_delta_ll_vs_test_purchases(
        user_ll_df=user_ll,
        prev_col="ll_personalized_poisson",
        new_col="ll_experimental_hawkes",
        purchases_col="test_purchases",
        out_path=output_dir / "delta_ll_vs_test_purchases_personalized_to_hawkes.png",
        title="Per-user delta LL vs test purchases: personalized Poisson -> Hawkes",
    )
